...
import {LogoPertenakan,Search,HomePertanian1 } from '../../../assets'
import * as OpenAnything from 'react-native-openanything';

export default class HomePertenakan extends Component {
	render() {
	return (
		<View style={styles.page}>
				<View style={styles.top}>
					<View style={styles.header}>
					<Image source={LogoPertenakan} style={styles.icon}/>
					<Text style={styles.text}> Bidang Pertenakan</Text>
					</View>
				</View>
