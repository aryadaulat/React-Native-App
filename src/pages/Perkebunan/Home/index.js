...
import {LogoPerkebunan,Search,HomePertanian1 } from '../../../assets'
import * as OpenAnything from 'react-native-openanything';

export default class HomePerkebunan extends Component {
	render() {
		return (
			<View style={styles.page}>
				<View style={styles.top}>
					<View style={styles.header}>
					<Image source={LogoPerkebunan} style={styles.icon}/>
					<Text style={styles.text}> Bidang Perkebunan</Text>
					</View>
				</View>
